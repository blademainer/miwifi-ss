...
cd /tmp
rm -rf *.sh
wget ftp://ftp.okss.tk/miwifi/r2d/r2d_ss.sh
...
cd /tmp
rm -rf *.sh
wget ftp://ftp.okss.tk/miwifi/r2d/r2d_uninstall.sh
...
cd /tmp
rm -rf *.sh
wget ftp://ftp.okss.tk/miwifi/mini/mini_ss.sh
...
cd /tmp
rm -rf *.sh
wget ftp://ftp.okss.tk/miwifi/mini/mini_uninstall.sh
...
cd /tmp
rm -rf *.sh
wget ftp://ftp.okss.tk/miwifi/r3/r3_ss.sh
...
cd /tmp
rm -rf *.sh
wget ftp://ftp.okss.tk/miwifi/r3/r3_uninstall.sh
